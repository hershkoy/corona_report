...
class DataProvider(object):
    ...
    def __init__(self):
        ...
        self.df_acc = pd.read_csv('ukaccidents/data/accidents_2005_5000lines.csv',usecols=DataProvider.RAW_COLS)
        ...
        with open('ukaccidents/data/UK_Hospital.csv', "r", encoding="cp1252") as f:
            for line in f:
